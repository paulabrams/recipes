...
3. **Heat smoker**: Bring temperature to 235°F (113°C) and maintain between 200-235°F (93-113°C).

### Smoking Process

6. **Place chicken**: Put chicken in smoker breast-side down initially.

2. **First phase**: Smoke for 1.5-2 hours, then flip breast-side up to finish.

3. **Monitor temperature**: Cook until internal temperature reaches 160°F (71°C) at the meatiest part of the breast.

4. **Total time**: Plan for approximately 1 hour per pound, typically 4+ hours total.

5. **Rest**: Let chicken rest for at least 10 minutes before serving to allow juices to redistribute.
